...
function Wordle() {
  ...
  let defaultKeyboard = [
    ...
    new Keyboard("ı", "#808384", "I"),
    new Keyboard("i", "#808384", "İ"),
  ...
  function checkChar(char, index) {
    if (char === SELECTEDWORDCHARS[index]) {
      ...
      newKeyboard
        .filter((key) => key.key === char && key.color != "green")
        .map((key) => {
          key.color = "orange";
        });
    } else {
  ...
  return (
    <>
      <div className="body">
        ...
        <div className="input">
          {win == 3 ? (
            <div className="not-valid-word">
              <p>Bu kelime mevcut değil 🤓</p>
            </div>
          ) : win == 1 ? (
